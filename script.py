...
# function to return the destination index of the traveler
...
# define empty list of attractions
# attractions = []
...
# return a list of attractions based on the destination and input attraction
...
# function that matches attractions with traveler interests
